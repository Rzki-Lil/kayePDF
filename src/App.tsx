...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-white dark:bg-[#121212]">
      <Titlebar />
      <NotificationContainer />
      
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <aside className="sidebar w-64 bg-slate-50 dark:bg-[#1a1a1a] border-r border-slate-200 dark:border-[#4d4948] flex flex-col py-8">
                ...
                <div className="p-16 max-w-5xl mx-auto h-full flex flex-col justify-center">
                  <header className="mb-12">
                    <h1 className="text-5xl font-black tracking-tighter text-slate-900 dark:text-white mb-4">
                      Simple. Local. <span className="text-sage-600">Secure.</span>
                    </h1>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <ToolCard 
                      ...
                      icon={<FileStack size={32} className="text-sage-600" />}
...
function ToolCard({ title, desc, icon, onClick }: any) {
  return (
    <motion.div 
      ...
      whileTap={{ scale: 0.98 }}
    >
      <div className="w-16 h-16 rounded-3xl bg-sage-50 dark:bg-sage-950/30 flex items-center justify-center mb-8 transition-colors group-hover:bg-sage-100 dark:group-hover:bg-sage-900/50">
        {icon}
      </div>
